function getDateUrl() {
    ...
    return `/rmrb/html/${year}-${month > 10 ? month : '0' + month}/${day > 10 ? day : '0' + day}/`;
}

function home_build_url(url, html, headers) {
    return `${getDateUrl()}/nbs.D110000renmrb_01.htm`;
}
...
function book_parse(url, html, headers) {
    ...
    var book = {
        ...
        cover: $('div.paper > img').attr('src').replace('../../..', 'http://paper.people.com.cn/rmrb')
    };
    var chapters = [];
